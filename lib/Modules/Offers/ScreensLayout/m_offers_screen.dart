...
class MediumOffersScreen extends StatefulWidget {
  const MediumOffersScreen({Key? key}) : super(key: key);

  @override
  State createState() => _MediumOffersScreenState();
}

class _MediumOffersScreenState extends StateMVC<MediumOffersScreen> {
  _MediumOffersScreenState() : super(OffersController()) {
