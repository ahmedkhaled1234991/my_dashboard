...
class MediumAlbumScreen extends StatefulWidget {
  const MediumAlbumScreen({Key? key}) : super(key: key);

  @override
  State createState() => _MediumAlbumScreenState();
}

class _MediumAlbumScreenState extends StateMVC<MediumAlbumScreen> {
  _MediumAlbumScreenState() : super(AlbumController()) {
    con = AlbumController();
  }
