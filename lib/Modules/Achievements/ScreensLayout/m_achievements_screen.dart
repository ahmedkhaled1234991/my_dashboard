...
class MediumAchievementsScreen extends StatefulWidget {
  const MediumAchievementsScreen({Key? key}) : super(key: key);

  @override
  State createState() => _MediumAchievementsScreenState();
}

class _MediumAchievementsScreenState
    extends StateMVC<MediumAchievementsScreen> {
  _MediumAchievementsScreenState() : super(AchievementsController()) {
