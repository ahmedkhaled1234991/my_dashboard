...
class MediumReportsScreen extends StatefulWidget {
  const MediumReportsScreen({Key? key}) : super(key: key);

  @override
  State createState() => _MediumReportsScreenState();
}

class _MediumReportsScreenState extends StateMVC<MediumReportsScreen> {
  _MediumReportsScreenState() : super(ReportsController()) {
