...
class CustomTextFieldWidget extends StatelessWidget {
  ...
  InputBorder? getBorder({double? radius, Color? color}) {
    ...
    return OutlineInputBorder(
      ...
      borderSide:
          BorderSide(color: color ?? ThemeClass.darkGreyColor, width: 1),
    );
  }
    ...
    return SizedBox(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          enabledBorder:
              getBorder(radius: borderRadiusValue, color: borderColor),
          disabledBorder:
              getBorder(radius: borderRadiusValue, color: borderColor),
          focusedBorder: getBorder(
              radius: borderRadiusValue,
              color: focusedBorderColor ?? ThemeClass.primaryColor),
          border:
              getBorder(radius: borderRadiusValue, color: focusedBorderColor),
          ...
          hintStyle: hintStyle ??
              ThemeStyleHelper.s16SemiBoldTextStyle
                  .copyWith(color: ThemeClass.textGreyColor),
        ),
        onChanged: onchange,
